...
procedure str1 is
  ...
  function term1 return C_String.String_t;
  pragma Import (C, term1, "cstr_terminated1");

  procedure term2
    (str : in C_String.String_t);
  pragma Import (C, term2, "cstr_terminated2");

  procedure unterm1
    (str  : out C_String.Char_Array_t;
     size : out C.size_t);
  pragma Import (C, unterm1, "cstr_unterminated1");

  procedure unterm2
    (str  : in C_String.Char_Array_t;
     size : in C.size_t);
  pragma Import (C, unterm2, "cstr_unterminated2");

  terminated   : C_String.String_t;
  unterminated : C_String.Char_Array_t;
...
begin
  ...
  declare
    ...
    C_Term  : constant C_String.String_t := C_String.To_C_String (C_Array'Unchecked_Access);
  ...
  declare
    ...
    C_Unterm : constant C_String.Char_Array_t := C_String.To_C_Char_Array (C_Array'Unchecked_Access);
